#ifndef _ROS_realsense_person_BoundingBox_h
#define _ROS_realsense_person_BoundingBox_h
...
namespace realsense_person
{
  ...
  class BoundingBox : public ros::Msg
  {
    ...
    const char * getType(){ return "realsense_person/BoundingBox"; };
    const char * getMD5(){ return "a4e91affcb4ac5719e71f56994988f12"; };
