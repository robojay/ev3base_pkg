#ifndef _ROS_SERVICE_GetConfigurableNodes_h
#define _ROS_SERVICE_GetConfigurableNodes_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETCONFIGURABLENODES[] = "configuration_node/GetConfigurableNodes";

  class GetConfigurableNodesRequest : public ros::Msg
  {
    public:

    GetConfigurableNodesRequest()
    {
    }
    ...
    const char * getType(){ return GETCONFIGURABLENODES; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetConfigurableNodesResponse : public ros::Msg
  {
    public:
  ...
  class GetConfigurableNodes {
    public:
    typedef GetConfigurableNodesRequest Request;
    typedef GetConfigurableNodesResponse Response;
  };
