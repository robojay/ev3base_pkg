#ifndef _ROS_SERVICE_DeactivateNodes_h
#define _ROS_SERVICE_DeactivateNodes_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char DEACTIVATENODES[] = "configuration_node/DeactivateNodes";

  class DeactivateNodesRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return DEACTIVATENODES; };
    const char * getMD5(){ return "3d07bfda1268b4f76b16b7ba8a82665d"; };

  };

  class DeactivateNodesResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    DeactivateNodesResponse():
      success(0)
    {
    }
  ...
  class DeactivateNodes {
    public:
    typedef DeactivateNodesRequest Request;
    typedef DeactivateNodesResponse Response;
  };
