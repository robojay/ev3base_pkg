#ifndef _ROS_SERVICE_EditScenario_h
#define _ROS_SERVICE_EditScenario_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char EDITSCENARIO[] = "configuration_node/EditScenario";

  class EditScenarioRequest : public ros::Msg
  {
    public:
      typedef const char* _scenarioName_type;
      _scenarioName_type scenarioName;
      typedef const char* _newScenarioName_type;
      _newScenarioName_type newScenarioName;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t length_newScenarioName = strlen(this->newScenarioName);
      varToArr(outbuffer + offset, length_newScenarioName);
      offset += 4;
      memcpy(outbuffer + offset, this->newScenarioName, length_newScenarioName);
      offset += length_newScenarioName;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_scenarioName;
      uint32_t length_newScenarioName;
      arrToVar(length_newScenarioName, (inbuffer + offset));
      offset += 4;
      for(unsigned int k= offset; k< offset+length_newScenarioName; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_newScenarioName-1]=0;
      this->newScenarioName = (char *)(inbuffer + offset-1);
      offset += length_newScenarioName;
    ...
    const char * getType(){ return EDITSCENARIO; };
    const char * getMD5(){ return "f26fe251326af966e5c68e7d8f62a229"; };

  };

  class EditScenarioResponse : public ros::Msg
  {
    public:
  ...
  class EditScenario {
    public:
    typedef EditScenarioRequest Request;
    typedef EditScenarioResponse Response;
  };
