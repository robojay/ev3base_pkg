#ifndef _ROS_SERVICE_EditNode_h
#define _ROS_SERVICE_EditNode_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char EDITNODE[] = "configuration_node/EditNode";

  class EditNodeRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return EDITNODE; };
    const char * getMD5(){ return "e3dbd023a2f21cba578ae6a43b685880"; };

  };

  class EditNodeResponse : public ros::Msg
  {
    public:
  ...
  class EditNode {
    public:
    typedef EditNodeRequest Request;
    typedef EditNodeResponse Response;
  };
