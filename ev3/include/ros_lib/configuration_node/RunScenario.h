#ifndef _ROS_SERVICE_RunScenario_h
#define _ROS_SERVICE_RunScenario_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RUNSCENARIO[] = "configuration_node/RunScenario";

  class RunScenarioRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return RUNSCENARIO; };
    const char * getMD5(){ return "01bfa348e12a2a9d51d269d400453e2e"; };

  };

  class RunScenarioResponse : public ros::Msg
  {
    public:
  ...
  class RunScenario {
    public:
    typedef RunScenarioRequest Request;
    typedef RunScenarioResponse Response;
  };
