#ifndef _ROS_SERVICE_Reinforce_h
#define _ROS_SERVICE_Reinforce_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char REINFORCE[] = "realsense_person/Reinforce";

  class ReinforceRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return REINFORCE; };
    const char * getMD5(){ return "f4a59d306aa3d4186005a363b6508e9e"; };

  };

  class ReinforceResponse : public ros::Msg
  {
    public:
